  ...
  return (
    <header className="flex flex-col sm:flex-row justify-between items-center mb-12">
      <div className="relative group">
        <a href="/" className="text-2xl font-semibold mb-4 sm:mb-0 sm:block hidden cursor-pointer">
          <span>アロック</span>
        </a>
      ...
      <nav className="flex flex-wrap justify-center items-center gap-4">
        <a href="https://blog.alk.pw" className="hover:text-white transition-colors">Blog</a>
